        ...
        for i, name in enumerate(os.listdir(self.data_dir)):
            ...
            with open(self.pairs_filepath, "a") as f:
                for i in range(1):
                    ...
                    img1 = file1.split("_")[0]
                    img2 = file2.split("_")[0]
                    picid1 = file1.split("_")[1].lstrip("0").rstrip(self.img_ext)
                    if picid1=='':
                        picid1 = '0'
                    picid2 = file2.split("_")[1].lstrip("0").rstrip(self.img_ext)
                    if picid2 == '':
                        picid2 = '0'
                    f.write(img1 + "\t" + picid1 + "\t" + img2 + "\t" + picid2 + '\n')
                #f.write("\n")
